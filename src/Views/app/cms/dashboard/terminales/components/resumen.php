    ...
    <div class="card">
            ...
            <form action="javascript:" method="post" autocomplete="off">
                <div class="form-group mb-0">
                    <div class="input-group input-group-lg input-group-flush">
                        ...
                        <input ng-model="searchTerminal" type="search" class="form-control" placeholder="Buscar" ng-disabled="usuariosTerminales.length <= 0">
                    </div>
                </div>
            </form>
        </div>
        <div class="card-body">
            <ul class="list-group list-group-flush list my--3">
                <li class="list-group-item px-0 hover" ng-if="usuariosTerminales.length <= 0">
                ...
                <li class="list-group-item px-0 hover" ng-if="usuariosTerminales.length > 0" ng-repeat="rows in usuariosTerminales | filter : searchTerminal" ng-click="showOptionsList(rows.id_sg_terminal_usuario)">
                    <div class="row align-items-center" ng-hide="selectedRow == rows.id_sg_terminal_usuario">
                        ...
                        <div class="col ml--2">
                            <h4 class="mb-0">
                                <a href="javascript:">{{ rows.usuario }}</a>
                            </h4>
