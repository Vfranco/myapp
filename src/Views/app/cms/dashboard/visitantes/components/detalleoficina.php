        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col text-right">
                    ...
                    <button class="btn btn-sm btn-primary" ng-show="resultResource" ng-click="abrirIntegrantes()">Añadir Integrante</button>
            ...
            <form id="frm-create-oficina" action="javascript:" method="post" autocomplete="off" ng-hide="enableFormTorre">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pisoNivel" class="form-control required" ng-model="piso" ng-readonly="disableInputs">
                    </div>
                    <div class="form-group">
                        <label class="form-control-label">Oficina</label>
                        <input type="text" name="nombreOficina" class="form-control required" ng-model="oficina">
                    </div>
                    <div class="form-group">
                        <label class="form-control-label">Nombre Oficina / Área</label>
                        <input type="text" name="areaOficina" class="form-control required" ng-model="area">
                    </div>
                </div>
