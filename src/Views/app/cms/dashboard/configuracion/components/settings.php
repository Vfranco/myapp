        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush list my--3" ng-hide="muestraFormEps">
                    ...
                    <li class="list-group-item px-0 hover" ng-if="eps.length > 0" ng-repeat="items in eps" ng-click="showOptionsList(items.id_sg_eps)">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush list my--3" ng-hide="muestraFormArl">
                    ...
                    <li class="list-group-item px-0 hover" ng-if="arl.length > 0" ng-repeat="items in arl" ng-click="showOptionsArl(items.id_sg_arl)">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush list my--3" ng-hide="muestraFormCargo">
                    ...
                    <li class="list-group-item px-0 hover" ng-if="cargos.length > 0" ng-repeat="items in cargos" ng-click="showOptionsCargo(items.id_sg_cargo)">
